...
public class MainActivity extends AppCompatActivity {
    ...
    static final String APP_ID = "73999";
    static final String AUTH_KEY = "PX7fsRsy8L95YTp";
    static final String AUTH_SECRET = "Z2LLAeB7xBNxzM3";
    static final String ACCOUNT_KEY = "CYQ_Q1-bvsMoZhQqGAAv";
